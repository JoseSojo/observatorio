...
export default function AbstractReportUniqueDocument() {

    const { crud, type, id } = useParams() as { crud: string, type: string, id: string };
    ...
    useEffect(() => {
        const Execute = async () => {
            const url = `${API}/${crud}/report/${type}/${id}`;
